...
class MAX30102():
    ...
    def setup(self, led_mode=0x03):
        """
        This will set up the device with the values written in sample Arduino code.
        """
        # INTR setting
    ...
    def read_sequential(self, amount=100):
        """
        This function will read the red-led and ir-led 100 times.
        This works as a blocking function.
        """
        red_buf = []
        ir_buf = []
        count = amount
